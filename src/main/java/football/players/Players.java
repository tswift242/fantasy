...
public final class Players {
	...
	public static final QB PEYTON = new QB("peyton",310.96,
	...
	public static final QB RODGERS = new QB("rodgers",343.6,
	...
	public static final QB PALMER = new QB("palmer",224.32,
	...
	public static final QB KOLB = new QB("kolb",84.76,
	...
	public static final QB QUINN = new QB("quinn",44.24,
	...
	public static final QB LEINART = new QB("leinart",2.6,
	...
	public static final QB SANCHEZ = new QB("sanchez",118.12,
	...
	public static final QB WEEDEN = new QB("weeden",165.6,
	...
	//RB
	public static final RB LYNCH = new RB("lynch",246.6,
	...
	public static final RB RICE = new RB("rice",222.1,
			...
			newSet(new Stat<Misc>(Misc.FUMB_TD,0),new Stat<Misc>(Misc.TWO_PT_CONV,0),new Stat<Misc>(Misc.FUMB_LOST,0),new Stat<Misc>(Misc.FUMB,1)));
	public static final RB FOSTER = new RB("foster",262.1,
	...
	public static final RB RBUSH = new RB("r bush",171.8,
	...
	public static final RB MATHEWS = new RB("mathews",97.9,
			...
			newSet(new Stat<Misc>(Misc.FUMB_TD,0),new Stat<Misc>(Misc.TWO_PT_CONV,0),new Stat<Misc>(Misc.FUMB_LOST,2),new Stat<Misc>(Misc.FUMB,2)));
	public static final RB JONESDREW = new RB("jones-drew",62,
			...
			newSet(new Stat<Misc>(Misc.FUMB_TD,0),new Stat<Misc>(Misc.TWO_PT_CONV,0),new Stat<Misc>(Misc.FUMB_LOST,0),new Stat<Misc>(Misc.FUMB,2)));
	public static final RB HILLMAN = new RB("hillman",43.2,
	...
	public static final RB REDMAN = new RB("redman",71.4,
	...
	public static final WR AMENDOLA = new WR("amendola",83.4,
	...
	public static final WR BEDWARDS = new WR("b edwards",25.9,
			newSet(new Stat<Rec>(Rec.REC,18),new Stat<Rec>(Rec.YDS,199),new Stat<Rec>(Rec.TD,1)),
			newSet(new Stat<Misc>(Misc.FUMB_TD,0),new Stat<Misc>(Misc.TWO_PT_CONV,0),new Stat<Misc>(Misc.FUMB_LOST,0),new Stat<Misc>(Misc.FUMB,0)));
	public static final WR MANNINGHAM = new WR("manningham",55.3,
			newSet(new Stat<Rec>(Rec.REC,42),new Stat<Rec>(Rec.YDS,449),new Stat<Rec>(Rec.TD,1)),
			newSet(new Stat<Misc>(Misc.FUMB_TD,0),new Stat<Misc>(Misc.TWO_PT_CONV,0),new Stat<Misc>(Misc.FUMB_LOST,1),new Stat<Misc>(Misc.FUMB,2)));
	public static final WR SHOLMES = new WR("s holmes",31.2,
	...
	public static final WR HDOUGLAS = new WR("h douglas",45.9,
			newSet(new Stat<Rec>(Rec.REC,38),new Stat<Rec>(Rec.YDS,395),new Stat<Rec>(Rec.TD,1)),
			newSet(new Stat<Misc>(Misc.FUMB_TD,0),new Stat<Misc>(Misc.TWO_PT_CONV,0),new Stat<Misc>(Misc.FUMB_LOST,0),new Stat<Misc>(Misc.FUMB,1)));
	//DEF
	public static final DEF CHICAGO = new DEF("chicago",223,
	...
	public static final DEF SANFRAN = new DEF("san fransisco",157,
	...
	public static final DEF SEATTLE = new DEF("seattle",182,
	...
	public static final DEF CLEVELAND = new DEF("cleveland",123,
	...
	public static final DEF NEWORLEANS = new DEF("new orleans",111,
	...
	public static final DEF JACKSONVILLE = new DEF("jacksonville",68,
	...
	public static final DEF OAKLAND = new DEF("oakland",58,
	...
	//K
	public static final K GOSTKOWSKI = new K("gostkowski",157,
	...
	public static final K MBRYANT = new K("m bryant",151,
	...
	public static final K TUCKER = new K("tucker",140,
	...
	public static final K SUISHAM = new K("suisham",119.9,
	...
	public static final K CUNDIFF = new K("cundiff",38,
	...
	public static final K FORBATH = new K("forbath",86,
	...
	public static final K SCOBEE = new K("scobee",95,
	...
	public static final K FOLK = new K("folk",99,
	...
	public static final K CROSBY = new K("crosby",117,
